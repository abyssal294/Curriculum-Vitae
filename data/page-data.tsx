...
export const aboutMe = {
	title: "O MENI",
	body: [
		"Kot usposobljen diplomirani zdravstvenik v urgentni dejavnosti si želim preiti v svet razvoja spletnih strani in programiranja zaradi veselja in strasti do le-tega, kot tudi zaradi želje po samoizpolnitvi. Izkušnje v zdravstveni negi so me osebnostno razvile, utrdile ter dvignile moje sposobnosti za multitasking, komunikacijo, prioritizacijo in delo pod pritiskom, kar verjamem, da bo neprecenljivo na moji novi karierni poti.",
		"Veliko željo imam postati poklicni programer. Učenje sem pričel s spletnim bootcampom za razvoj spletnih strani, kjer sem se seznanil z HTML, CSS, SQL in noSQL bazami (največ MongoDB) in Javascript-om, okoljem jQuery, Node.js in React.js, učim pa se delati tudi s TypeScript-om in Next.js, s katerima sem tudi ustvaril ta življenjepis. Koda je dostopna na GitHub-u, povezava je pod 'kontakti,' kot tudi povezava do enega izmed končanih projektov.",
		"Programiranje mi je izjemno zanimivo, žal mi je, da se ga nisem lotil že prej. Voljan sem se naučiti karkoli, kar bo zahtevano, vključno z novimi framework-i, pa tudi novimi programskimi jeziki. Skozi poznavanje JavaScripta se učim tudi, kako programski jeziki delujejo pod površjem, zato mi bo učenje novih jezikov nekoliko olajšano, prav tako pa se s tem učim pisati kvalitetnejšo kodo."
	],
};
